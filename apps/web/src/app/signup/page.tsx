      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/10 bg-[oklch(0.21_0.01_265)] p-7 shadow-2xl shadow-black/40">
          <div className="mb-6 space-y-1">
            ...
            <p className="text-[13px] text-slate-400">Set up a new workspace to start monitoring.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Building2 className="pointer-events-none absolute left-2.5 top-1/2 size-4 -translate-y-1/2 text-slate-500" strokeWidth={1.75} />
                <Input
                  id="orgName"
                  type="text"
